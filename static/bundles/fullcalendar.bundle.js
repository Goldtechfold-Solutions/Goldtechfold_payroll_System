    ...
    return function (n) {
        ...
        var h = n(0), c = n(4), p = n(5), i = function () {
            ...
            return t.prototype.opt = function (t) {
                ...
                return d || ((o = this.opt("dateIncrement")) ? (s = h.duration(o), d = s < n ? c.computeDurationGreatestUnit(s, o) : i) : d = i), n.as("days") <= 1 && this._view.isHiddenDay(a) && (a = this._view.skipHiddenDays(a, e)).startOf("day"), r(), this.trimHiddenDays(u) || (t = this._view.skipHiddenDays(t, e), r()), u
        ...
        var i = n(2), f = n(3), g = n(0), v = n(16), y = n(4), o = n(10), r = n(7), m = n(23), s = n(13), w = n(18),
            a = n(6), l = function (e) {
                ...
                return i.__extends(t, e), t.prototype.end = function () {
                    ...
                    var r, i, o, s, a, l, u, d = this, c = this.component, h = this.view,
                        p = (i = e, (u = v.dataAttrPrefix) && (u += "-"), (o = i.data(u + "event") || null) && (null == (s = (o = "object" == typeof o ? f.extend({}, o) : {}).start) && (s = o.time), a = o.duration, l = o.stick, delete o.start, delete o.time, delete o.duration, delete o.stick), null == s && (s = i.data(u + "start")), null == s && (s = i.data(u + "time")), null == a && (a = i.data(u + "duration")), null == l && (l = i.data(u + "stick")), {
                            eventProps: o,
                    ...
                    (this.dragListener = new m.default(c, {
                        interactionStart: function () {
                            ...
                            i ? (r = d.computeExternalDrop(i, p)) ? (e = new w.default(r.buildInstances()), n = p.eventProps ? c.isEventInstanceGroupAllowed(e) : c.isExternalInstanceGroupAllowed(e)) : n = !1 : n = !1, n || (r = null, y.disableCursor()), r && c.renderDrag(c.eventRangesToEventFootprints(e.sliceRenderRanges(c.dateProfile.renderUnzonedRange, h.calendar)))
                        }, hitOut: function () {
                            r = null
                        }, hitDone: function () {
                            y.enableCursor(), c.unrenderDrag()
                        }, interactionEnd: function (t) {
                            r && h.reportExternalDrop(r, Boolean(p.eventProps), Boolean(p.stick), e, t, n), d.isDragging = !1, d.dragListener = null
                        }
                    })).startDrag(t)
            ...
            return r.__extends(t, i), t.prototype.end = function () {
                ...
                var v = this.dragListener = new m.default(h, {
                    scroll: this.opt("dragScroll"), subjectEl: n, subjectCenter: !0, interactionStart: function (t) {
                        ...
                        var i, r, o, s = !0;
                        a.hit && (n = a.hit), i = n.component.getSafeHitFootprint(n), r = t.component.getSafeHitFootprint(t), i && r ? (u = d.computeEventDropMutation(i, r, g)) ? (o = f.buildMutatedEventInstanceGroup(g.id, u), s = c.isEventInstanceGroupAllowed(o)) : s = !1 : s = !1, s || (u = null, y.disableCursor()), u && h.renderDrag(c.eventRangesToEventFootprints(o.sliceRenderRanges(c.dateProfile.renderUnzonedRange, p)), a, v.isTouch) ? l.hide() : l.show(), e && (u = null)
                    }, hitOut: function () {
